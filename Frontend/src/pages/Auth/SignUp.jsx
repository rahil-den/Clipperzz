...
const SignUp = () => {
    ...
    const handleGoogleResponse = useCallback(async (response) => {
        ...
        try {
            ...
            console.log("[SignUp.jsx] Google Sign Up Successful", result);
            ...
            console.error("[SignUp.jsx] Google Sign Up Error:", error);
        ...
        if (window.google?.accounts?.id) {
            window.google.accounts.id.prompt((notification) => {
                if (notification.isNotDisplayed() || notification.isSkippedMoment()) {
                    console.log("[SignUp.jsx] One Tap not available, using renderButton fallback");
